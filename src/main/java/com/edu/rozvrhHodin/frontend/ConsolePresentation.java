...
public class ConsolePresentation {
    public static void consoleWelcome(){
        ...
        System.out.println("Zadejte název metody z následujícího výčtu: help, addStudent, addSubject, findAllStudents, findStudent, findAllSubjects, findStudentSubject, findSubject,findStudentsSubjects, findStudentsOnSubject, deactivateStudent");
